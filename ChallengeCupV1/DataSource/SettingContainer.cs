...
namespace ChallengeCupV1.DataSource
{
    ...
    public static class SettingContainer
    {
        ...
        public static string WaveDataDir = @"C:\debug\FBG解调系统数据文件\数据文件\2017-03-02\";
        /// <summary>
        ...
        /// </summary>
        public static double MaxYWavePlotTimeDomain = 1552.9;
        public static double MinYWavePlotTimeDomain = 1552.8;
